...
* TURMA C - 2021/2
*
* Trabalho 2: Fornecidos pelo Professor
*
* GLOBALS.H
*
...
//
//
//Juntei o necessário de globals.h e riscv.h, esses fornecidos pelo professor 
// adcionei algumas variáveis
//  globals.h
//  RV32Ic++
//
//
...
enum FUNCT3 {
    ...
    SLTIU3=03,	SLLI3=01,	SRAI3 = 05,     SRI3=05
};
